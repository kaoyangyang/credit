...
function fnShowData(result){
	...
	for(var i=0;i<resultJson.length;i++){
		...
		html+='	<span class="check_span" id="'+resultJson[i].ad_id+','+resultJson[i].ispush+'" onclick="fnCheck(this);">详情</span>';
		html+='</div>';
		html+='</td>';
		html+='</tr>';
...
//	alert(one.id);
	...
	window.location.href="${pageContext.request.contextPath}/manager/tocheck.do?ad_id="+values[0]+"&ispush="+values[1];
}
